...
public class SysUserController extends BaseController {
    ...
    @ApiOperation("导入用户数据")
    @ApiImplicitParams({
        @ApiImplicitParam(name = "file", value = "用户数据文件", required = true, dataType = "MultipartFile", paramType = "form"),
        @ApiImplicitParam(name = "updateSupport", value = "是否支持更新", required = true, dataType = "boolean", paramType = "query")
    })
